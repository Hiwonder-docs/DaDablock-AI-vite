...
### 4.3.5 Glowing Ultrasonic Sensor

#### (1) Overview

This is a glowing ultrasonic ranging module using an industrial-grade ultrasonic ranging chip. The chip integrates ultrasonic transmitting circuits, ultrasonic receiving circuits, and digital processing circuits internally. The module adopts an I2C communication interface, allowing distance measured by the ultrasonic sensor to be read via I2C communication. The sensor is compatible with LEGO holes for more creative DIY designs.

<img src="../_static/media/chapter_4/section_3/media/subsection_5/image1.png"  class="common_img" style="width:300px;" >
...
| Interface model | 5264-4AW |
| Dimensions | 55.5 × 23.5 × 23.8 mm |

#### (3) Wiring Diagram

<img src="../_static/media/chapter_4/section_3/media/subsection_5/image2.png"  class="common_img" style="width:450px;" >

- **It supports connection to any port among P1, P2, P3, and P4 on the controller.**

#### (4) Practical Examples

Case: Ultrasonic Distance-Sensing Light Control
Program logic: After downloading the program, when the ultrasonic sensor detects an obstacle ahead at a distance less than or equal to 15 cm, both RGB lights on the ultrasonic sensor turn red simultaneously. When the distance is greater than 15 cm, both RGB lights on the ultrasonic sensor turn off. The detection status refreshes every 0.1 seconds to ensure timely response.

<img src="../_static/media/chapter_4/section_3/media/subsection_5/image3.png"  class="common_img" style="width:500px;" >
...
> [!NOTE]
>
> * **When using the ultrasonic sensor, initialization of the ultrasonic sensor interface is required at startup. The program uses Turn Off Glowing Ultrasonic RGB Lights, All at startup because the ultrasonic sensor lights up blue upon power-on.**
>
> * **The source files are available for download under [1. Source Code / 03 Program Files for Starter Projects](https://drive.google.com/drive/folders/1C_cT51H9adfUnSPw9l57vPrQQ2A_vUBa?usp=sharing).**
>
...
This is a sensor that detects ambient light intensity, typically used to create interactive projects that produce special effects as light intensity changes, such as automatic roadside lighting control systems and environmental monitoring systems. The sensor is compatible with LEGO holes for more creative DIY designs.

<img src="../_static/media/chapter_4/section_3/media/subsection_6/image1.png"  class="common_img" style="width:300px;" >
...
| Interface model | 5264-4AW |
| Dimensions | 39.5 × 23.5 × 17.3 mm |

#### (3) Wiring Diagram

<img src="../_static/media/chapter_4/section_3/media/subsection_6/image2.png"  class="common_img" style="width:400px;" >
...
Case: Light Sensing
Program logic: After downloading the program, light intensity values detected by the light sensor are displayed via the serial port.

<img src="../_static/media/chapter_4/section_3/media/subsection_6/image3.png"  class="common_img" style="width:500px;" >
...
> [!NOTE]
>
> * **Adjust Knob: After downloading the test program, rotate the knob counterclockwise to the maximum position, then slowly rotate the knob clockwise while observing the light intensity values detected by the light sensor, displayed on the serial port.**
>
> * **The source files are available for download under [1. Source Code / 03 Program Files for Starter Projects](https://drive.google.com/drive/folders/1C_cT51H9adfUnSPw9l57vPrQQ2A_vUBa?usp=sharing).**
>
...
The 4-channel line follower sensor can be used for line tracking identification. The sensor is compatible with LEGO holes for more creative DIY designs.

<img src="../_static/media/chapter_4/section_3/media/subsection_7/image1.png"  class="common_img" style="width:300px;" >
...
| Interface type | I2C |
| Interface model | 5264-4AW |
| Dimensions | 71.7 × 31.2 × 9 mm |

#### (3) Wiring Diagram

<img src="../_static/media/chapter_4/section_3/media/subsection_7/image2.png"  class="common_img" style="width:450px;" >

- **It supports connection to any port among P1, P2, P3, and P4 on the controller.**

#### (4) Learning Mode

The 4-channel line follower module can learn map backgrounds and line-tracking paths, such as black tracks, by pressing the button on the sensor. Complete learning according to the following steps:

<img src="../_static/media/chapter_4/section_3/media/subsection_7/image4.png"  class="common_img" style="width:300px;" >

① Point probe heads 1 to 4 of the 4-channel line follower sensor directly at the map background area and long press the learning button. At this time, indicator lights for probes 1 to 4 flash simultaneously, indicating background learning completion.

② Point probe heads 1 to 4 of the 4-channel line follower sensor directly at the line to be tracked and short press the learning button once. At this time, indicator lights for probes 1 to 4 flash simultaneously, indicating line learning completion.

③ When the middle two probes of the 4-channel line follower sensor flash, line follower sensor learning is complete.

The ground distance of the line-tracking probes during operation should be between 8 mm and 16 mm. Upon successful learning, the middle two probes flash. When the line-tracking probes detect tracking paths, the corresponding probe indicator lights turn on.

#### (5) Practical Examples

Case: 4-Channel Line Follower Channel Status Monitoring Display
Program logic: After downloading the program, test each line tracking probe using the 4-channel line follower module. When black lines are detected, output the corresponding probe numbers.

<img src="../_static/media/chapter_4/section_3/media/subsection_7/image3.png"  class="common_img" style="width:500px;" >
...
> [!NOTE]
>
> * **When using the 4-channel line follower sensor, initialization of the 4-channel line follower sensor interface is required at startup.**
>
> * **The source files are available for download under [1. Source Code / 03 Program Files for Starter Projects](https://drive.google.com/drive/folders/1C_cT51H9adfUnSPw9l57vPrQQ2A_vUBa?usp=sharing).**
>
...
This is a sensor for detecting external temperature and humidity, commonly used for creating interactive projects that react to temperature and humidity changes, such as environmental monitoring systems. The sensor is compatible with LEGO holes for more creative DIY designs.

<img src="../_static/media/chapter_4/section_3/media/subsection_8/image1.png"  class="common_img" style="width:350px;" >
...
| Humidity accuracy | ±2%RH at 25℃ |
| Resolution | Temperature: 0.01℃, Humidity: 0.024%RH |
| Communication method | I2C communication, connect to controller via 4-PIN wire |
| 7-bit I2C address | 0x38 |
| PWR description | Lights up after sensor power-on |
| Interface model | 5264-4AW |
| Dimensions | 39.5 × 23.2 mm |

#### (3) Wiring Diagram

<img src="../_static/media/chapter_4/section_3/media/subsection_8/image2.png"  class="common_img" style="width:400px;" >

- **It supports connection to any port among P1, P2, P3, and P4 on the controller.**

#### (4) Practical Examples

Case: Cyclically Read and Display Temperature and Humidity Data
Program logic: After downloading the program, temperature and humidity sensor data from port 1 are read cyclically. The current temperature data is output first, followed by a 1-second wait. The current humidity data is output, followed by a 1-second wait, repeating continuously to achieve real-time collection and alternating output of temperature and humidity data.

<img src="../_static/media/chapter_4/section_3/media/subsection_8/image3.png"  class="common_img" style="width:500px;" >
